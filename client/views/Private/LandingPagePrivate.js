...
export default function Villas() {
  ...
  <h2 class="text-3xl pb-40 tracking-tighter text-gray-200  p-4 self-center content-center absolute text-left w-full :text-4xl">Temukan Villa</h2>
  <h2 class="text-3xl pb-24 tracking-tighter text-gray-200 p-4 self-center content-center absolute text-left w-full :text-4xl"> Dengan Beragam</h2>
  <h2 class="text-5xl pb-4 tracking-tighter text-gray-800 font-bold p-4 self-center content-center absolute text-left w-full :text-4xl">Kenyamanan</h2>
