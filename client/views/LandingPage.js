  ...
  return (
    <>
      <div class="flex text-center">
        ...
        <h2 class="text-3xl text-right pb-40 tracking-tighter text-green-800  p-4 self-center content-center absolute text-left w-full :text-4xl">Find the best destination</h2>
        <h2 class="text-3xl text-right pb-24 tracking-tighter text-yellow-700  p-4 self-center content-center absolute text-left w-full :text-4xl"> For your next</h2>
        <h2 class="text-5xl text-right pb-4 tracking-tighter text-green-800 font-bold p-4 self-center content-center absolute text-left w-full :text-4xl">Holidays</h2>
  ...
  src="https://lh5.googleusercontent.com/proxy/2QFWqWUZvHX2F-LmQIAx0mRuwLz9S6wqToo1uVHTUmTB_ftZ7BGfB0TjB7L4Fyqa6BF4C1Y8TZKn0cqPRwIS-MSteg=s0-d" 
   />
      ...
      <div className="grid grid-cols-4 bg-green-50" >
        <h3 class="text-3xl pb-4 pl-20 tracking-tighter text-green-900  p-4 self-center content-center absolute text-left w-full text-2xl font-medium ">Holidays in a different way :</h3>
        <div className="relative">
          ...
          />
          <a class="-mt-20 ml-36 font-bold text-gray-800 text-sm absolute">Waterfall</a>
        </div>
        <div className="relative">
          <img class=" m-20  w-full rounded-xl" style={{ height: " 200px", width: " 200px" }}
            src="https://images.all-free-download.com/images/graphiclarge/mountain_lake_scene_painting_colored_cartoon_design_6841350.jpg"
          />
          <a class="-mt-20 ml-40 font-bold text-gray-800 text-sm absolute">Lake</a>
        </div>
        <div className="relative">
          <img class=" m-20  w-full rounded-xl" style={{ height: " 200px", width: " 200px" }}
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPY_YN1bCVqU7u6t4XZxrjMZC_Yx3-P-NoZw&usqp=CAU"
          />
          <a class="-mt-20 ml-40 font-bold text-gray-800 text-sm absolute">Forest</a>
        </div>
        <div className="relative">
          <img class=" m-20  w-full rounded-xl" style={{ height: " 200px", width: " 200px" }}
          ...
          />
          <a class="-mt-20 ml-36 font-bold text-gray-800 text-sm absolute">Long Road</a>
        </div>
        <div className="relative">
          <img class=" m-20  w-full rounded-xl" style={{ height: " 200px", width: " 200px" }}
          ...
          />
          <a class="-mt-20 ml-32 font-bold text-gray-800 text-sm absolute">Fishing in Lake</a>
        </div>
        <div className="relative">
          <img class=" m-20  w-full rounded-xl" style={{ height: " 200px", width: " 200px" }}
          ...
          />
          <a class="-mt-20 ml-36 font-bold text-gray-800 text-sm absolute">Camping</a>
        </div>
        <div className="relative">
          <img class=" m-20  w-full rounded-xl" style={{ height: " 200px", width: " 200px" }}
            src="https://image.freepik.com/free-vector/beach-cartoon-illustration_1196-552.jpg"
          />
          <a class="-mt-20 ml-40 font-bold text-gray-800 text-sm absolute">Beach</a>
        </div>
        <div className="relative">
          <img class=" m-20  w-full rounded-xl" style={{ height: " 200px", width: " 200px" }}
            src="https://st2.depositphotos.com/2704315/7961/v/950/depositphotos_79614250-stock-illustration-man-is-riding-bike-vector.jpg"
          />
          <a class="-mt-20 ml-40 font-bold text-gray-800 text-sm absolute">Riding</a>
        </div>
